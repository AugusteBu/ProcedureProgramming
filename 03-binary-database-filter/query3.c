...
int start_with_consonant = 0;
if((s.name[0] == 'A') ||  (s.name[0] == 'E') || (s.name[0] == 'I') || (s.name[0] == 'O') || (s.name[0] == 'Y') || (s.name[0] == 'U')){
    start_with_consonant = 0;
}
else
    start_with_consonant = 1;
			if(start_with_consonant == 1){ // *** first filter, conditions on the student
